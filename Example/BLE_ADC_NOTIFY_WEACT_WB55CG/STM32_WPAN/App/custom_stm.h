...
typedef enum
{
  ...
  CUSTOM_STM_ADC_VALUE_CHARACTERISTIC_READ_EVT,
  CUSTOM_STM_ADC_VALUE_CHARACTERISTIC_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_ADC_VALUE_CHARACTERISTIC_NOTIFY_DISABLED_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeAdc_Value_Characteristic;
