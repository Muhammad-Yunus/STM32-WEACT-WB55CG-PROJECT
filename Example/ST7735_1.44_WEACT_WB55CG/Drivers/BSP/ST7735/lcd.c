...
void LCD_Test(void)
{
    ...
    ST7735Ctx.Type = ST7735_1_44_inch_screen;
	#elif defined(TFT18)
	ST7735Ctx.Orientation = ST7735_ORIENTATION_PORTRAIT;
	ST7735Ctx.Panel = BOE_Panel;
	...
	#elif defined(TFT144)
	extern unsigned char WeActStudiologo_128_128[];
	ST7735_LCD_Driver.DrawBitmap(&st7735_pObj,0,0,WeActStudiologo_128_128);
	#elif defined(TFT18)
	...
	while (HAL_GPIO_ReadPin(KEY_GPIO_Port, KEY_Pin) != GPIO_PIN_SET)
	{
		...
		else if (get_tick() - tick <= 3000)
		{
			...
			ST7735_LCD_Driver.FillRect(&st7735_pObj, 0, ST7735Ctx.Height - 3, (get_tick() - tick - 1000) * ST7735Ctx.Width / 2000, 3, 0xF800);
		}
		else if (get_tick() - tick > 3000)
			break;
	}
